...
export const HEXAGON_CONTROLS = {
  showHexagon: {
    displayName: 'Show Horde Density Heatmap',
    type: 'boolean',
    value: false
  },
  radius: {
    displayName: 'Heatmap Radius',
    type: 'range',
    value: 250,
    step: 50,
    min: 50,
  ...
  upperPercentile: {
    displayName: 'Heatmap Upper Percentile',
    type: 'range',
    value: 95,
    step: 0.1,
    min: 80,
